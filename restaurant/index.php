    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="images/Spicy-Burger-995x356-ea8674d-kfc.png" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
          <img src="images/Spicy-Duo-995x356-df7811a-kfc.png" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h5></h5>
            <p></p>
          </div>
        ...
        <div class="carousel-item">
          <img src="images/995x356-3545ede-kfc.jpg" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
            <h5></h5>
            <p></p>
          </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <?php
              ...
              $get_deals="select * from deals where product_id >= 1 && product_id <=3";
